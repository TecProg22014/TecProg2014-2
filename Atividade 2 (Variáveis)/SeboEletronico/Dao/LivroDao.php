...
/**
 *  persistence of 'Livro'
 * */
 LivroDao 
	
	salvaLivro$livro, $id_dono
		/**
		 * Insertion method whose  is an object
		 * */
	...
	pesquisaLivro$titulo, $estadoNovo, $estadoUsado, $disponibilidadeVenda, $disponibilidadeTroca

		ifempty$disponibilidadeTroca && !empty$disponibilidadeVenda
			ifempty$estadoNovo && !empty$estadoUsado
	...
	alteraLivro$livro, $id_dono, $id_usuario

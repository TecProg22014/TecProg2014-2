...
<script src="./front/js/jquery-ui-1.10.3.custom.min.js"></script>	
...
<script src="./front/js/jquery.flot.time.js"></script>
...
<script src="./front/js/counter.min.js"></script>	
<script src="./front/js/raphael.2.1.0.min.js"></script>
<script src="./front/js/justgage.1.0.1.min.js"></script>	
...
<script src="./front/js/wizard.min.js"></script>
